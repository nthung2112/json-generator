...
const financeUseables: UseableModule = {
  currencyAmount: {
    action: () => faker.finance.amount().toString(),
    group: "Finance",
    explanation: "Returns an amount of currency",
    usage: "currencyAmount()",
    example: faker.finance.amount().toString(),
    type: Number,
  },
  currencyCode: {
  ...
  currencySymbol: {
    ...
    group: "Finance",
    explanation: "Returns the symbol of a currency",
...
export default financeUseables;
